...
namespace Drupal\israel_db\Controller;
...
//    $this->db->query(
//      "INSERT INTO {israel_db} (name, value, nid) VALUES (:name, :value, :nid)",
//      [
//        ':name' => 'Carlos',
...
//
//    $this->db->query(
//      "INSERT INTO {israel_db} (name, value) VALUES (:name, :value)",
//      [
//        ':name' => 'Ana',
...
//    );
    ...
    $result = $this->db->query("SELECT * FROM {israel_db} WHERE name = :name" , [':name' => 'Maria']);
  ...
  public function selectDinamico() {
    ...
    $query = $this->db->select('israel_db', 'c');
    $query->fields('c');
